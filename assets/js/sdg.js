  ...
  this.getData = function(options) {
    ...
    if (options.initial || options.changingSeries) {
      ...
      this.onSeriesesComplete.notify({
        ...
        euSDGSerieses: this.euSDGSerieses,
      });
    }
    ...
    this.onDataComplete.notify({
      ...
      isEUSDG: this.euSDG === 'euSDG' || this.euSDGSerieses.includes(this.selectedSeries),
    });
  };
};
...
var mapView = function () {
  ...
  this.initialise = function(indicatorId, precision, precisionItems, decimalSeparator, dataSchema, viewHelpers, modelHelpers, chartTitles, startValues, proxy, proxySerieses, euSDG, euSDGSerieses, allObservationAttributes) {
    $('.map').show();
    $('#map').sdgMap({
...
var EUSDG_PILL = '<span aria-describedby="euSDG-description" class="euSDG-pill">' + translations.t("indicator.euSDG") + '</span>';
...
function createSelectionsTable(chartInfo) {
    createTable(chartInfo.selectionsTable, chartInfo.indicatorId, '#selectionsTable', chartInfo.isProxy, chartInfo.isEUSDG, chartInfo.observationAttributesTable);
 ...
 * @return null
 */
function createTable(table, indicatorId, el, isProxy, isEUSDG, observationAttributesTable) {
